    ...
    <div className='min-h-screen flex flex-col'>
      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col gap-4'>
          ...
          <p>Lembre-se: Você pode utilizar a variável <code className='text-green-400'>{'{transcription}'}</code> no seu prompt para adicionado o conteúdo da transcrição do vídeo selecionado</p>
        </div>
